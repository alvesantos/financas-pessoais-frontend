...
describe("TransactionList", () => {
  it("mostra o dia, a descrição e o tipo embaixo dela", () => {
    render(<TransactionList transactions={[avulso]} onDelete={vi.fn()} onEdit={vi.fn()} />);
  ...
  it("linha sem categoria não inventa uma", () => {
    render(<TransactionList transactions={[receita]} onDelete={vi.fn()} onEdit={vi.fn()} />);
  ...
  it("marca a linha vinda de um fixo com a frequência", () => {
    render(<TransactionList transactions={[projetado]} onDelete={vi.fn()} onEdit={vi.fn()} />);
  ...
  it("apaga um lançamento avulso", async () => {
    ...
    render(<TransactionList transactions={[avulso]} onDelete={onDelete} onEdit={vi.fn()} />);
  ...
  it("mostra receita somando e despesa subtraindo", () => {
    render(<TransactionList transactions={[receita, avulso]} onDelete={vi.fn()} onEdit={vi.fn()} />);
  ...
  it("marca a linha vinda de uma dívida com o número da parcela", () => {
    render(<TransactionList transactions={[parcela]} onDelete={vi.fn()} onEdit={vi.fn()} />);
  ...
  it("oferece editar um lançamento avulso", async () => {
    ...
    render(<TransactionList transactions={[avulso]} onDelete={vi.fn()} onEdit={onEdit} />);
  ...
  it("explica o estado vazio em vez de só mostrar nada", () => {
    render(<TransactionList transactions={[]} onDelete={vi.fn()} onEdit={vi.fn()} />);
